// ----------------------------------------------------------------------------
// компонент отображения отчётов по заданному салону
// ----------------------------------------------------------------------------
import {Component, OnInit, OnDestroy} from '@angular/core';
import {IReportsComponent} from '../../models/interfaces/IReportsComponent';
...
export class ReportsComponent implements OnInit, OnDestroy {
  ...
  public component: IReportsComponent = {
  ...
  // коллекция отчётов заданной компании
  ...
  constructor(private _router: Router,
    ...
    Utils.helloComponent(Literals.reports);
  ...
  async ngOnInit(): Promise<void> {
    ...
    this._languageSubscription = this._languageService.languageSubject
      .subscribe((language: string) => {
        console.log(`[-ReportsComponent-subscribe--`);
  ...
  changeLanguageLiterals(language: string): void {
    console.log(`[-ReportsComponent-changeLanguageLiterals--`);
  ...
  async requestGetAllEmployeesByCompanyId(): Promise<void> {
    console.log(`[-ReportsComponent-requestGetAllEmployeesByCompanyId--`);

    // включение спиннера ожидания данных
    this.component.isWaitFlag = true;

    console.log(`--ReportsComponent-0-(обновление токена)-`);
    ...
    console.log(`--ReportsComponent-1-(запрос на получение)-`);
    ...
    console.log(`--ReportsComponent-result:`);
    //console.dir(result);

    console.log(`--ReportsComponent-2-(ответ на запрос получен)-`);
  ...
  createEmployee() {
    console.log(`[-ReportsComponent-createEmployee--`);
  ...
  ngOnDestroy() {
    console.log(`[-ReportsComponent-ngOnDestroy--`);
